...
function SubmitButton() {
  ...
  return (
    <Button type="submit" size="lg" className="w-full text-base md:text-lg" disabled={pending}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-base md:text-lg leading-relaxed md:leading-8 text-foreground/80">
                La eficiencia no es opcional en el mercado actual. Transformá tu empresa ahora y toma la delantera.
              </p>
            </div>
            <div className="w-full max-w-lg mx-auto bg-card p-6 md:p-8 rounded-lg shadow-lg">
                <form ref={formRef} action={formAction} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="comment">¿Cómo podemos ayudarte? (Opcional)</Label>
                        <Textarea id="comment" name="comment" rows={4} placeholder="Contanos sobre tu negocio..." />
                    </div>
                    <SubmitButton />
                </form>
            </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={closeDialogAndReset}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {state.message} Aquí tienes una sugerencia de mensaje de seguimiento generada por IA:
            </DialogDescription>
          </DialogHeader>
